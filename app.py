...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5000))  # Usa a variável de ambiente PORT, ou 5000 por padrão
    app.run(host="0.0.0.0", port=port)  # Especifica que o Flask deve rodar na porta correta
